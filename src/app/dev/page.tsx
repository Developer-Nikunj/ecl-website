                              ...
                              <tr>
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="avatar-sm bg-light rounded p-1 me-2">
                                      <img
                                        src="assets/backend/images/products/img-4.png"
                                        alt=""
                                        className="img-fluid d-block"
                                      />
                                    </div>
                                ...
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0 me-2">
                                      <img
                                        src="assets/backend/images/companies/img-1.png"
                                        alt=""
                              ...
                              <tr>
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0 me-2">
                                      <img
                                        src="assets/backend/images/companies/img-2.png"
                                        alt=""
                                        className="avatar-sm p-2"
                                      />
                                    </div>
                              ...
                              <tr>
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0 me-2">
                                      <img
                                        src="assets/backend/images/companies/img-3.png"
                                        alt=""
                                        className="avatar-sm p-2"
                                      />
                                    </div>
                              ...
                              <tr>
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0 me-2">
                                      <img
                                        src="assets/backend/images/companies/img-8.png"
                                        alt=""
                                        className="avatar-sm p-2"
                                      />
                                    </div>
                              ...
                              <tr>
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0 me-2">
                                      <img
                                        src="assets/backend/images/companies/img-5.png"
                                        alt=""
                                        className="avatar-sm p-2"
                                      />
                                    </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0 me-2">
                                      <img
                                        src="assets/backend/images/users/avatar-4.jpg"
                                        alt=""
                                        className="avatar-xs rounded-circle"
                                      />
                                    </div>
                ...
                <div className="card h-100 rounded-0">
                  <div className="card-body p-0">
                        ...
                        <div className="acitivity-item py-3 d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            ...
                            <div className="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                              ...
                              >
                                <img
                                  src="assets/backend/images/products/img-8.png"
                                  alt=""
                                  className="img-fluid d-block"
                                />
                              </a>
                              ...
                              >
                                <img
                                  src="assets/backend/images/products/img-10.png"
                                  alt=""
                                  className="img-fluid d-block"
                                />
                              </a>
                    ...
                    <div className="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                      <div className="card-body">
                        <img src="assets/backend/images/giftbox.png" alt="" />
                        <div className="mt-4">
