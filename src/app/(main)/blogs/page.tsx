          ...
          <div className="col-lg-9 mt-30">
            <div className="page-title-box">
              <span className="sub-title">
                <img src="assets/front/img/icon/magic-icon.svg" alt="" /> Blog
              </span>
              <h2 className="title">
                Expert insights from our SEO <br /> &amp; IT solutions blog your{" "}
                <br /> source for success
              </h2>
            </div>
          </div>
        ...
        <div className="col-lg-8 mt-30">
          <div className="blog_details_content">
            ...
            <div className="blog_details_item ul_li">
              <div className="xb-item--img">
                <a href="#!">
                  <img src="assets/front/img/blog/b-img04.jpg" alt="" />
                </a>
              </div>
              <div className="xb-item--holder">
                ...
                <h3 className="xb-item--title border-effect">
                  <a href="blog-details.html">
                    How to perform a comprehensive SEO audit for better
                    results..
                  </a>
                </h3>
                <span className="xb-item--content">
                  To perform a comprehensive SEO audit, check.
                </span>
                <div className="xb-item--button mt-50">
                  <a href="blog-details.html">
                    Read more <i className="far fa-arrow-right" />
            ...
            <div className="blog_details_item">
              <div className="xb-item--inner">
                ...
                <h3 className="xb-item--title border-effect">
                  <a href="blog-details.html">
                    The future of cybersecurity how IT <br /> solutions can
                    protect your data..
                  </a>
                </h3>
                <span className="xb-item--content">
                  The future of cybersecurity relies on innovative IT solutions
                  to protect data from evolving <br /> threats. Technologies
                  like AI and machine learning help identify.
                </span>
                <div className="xb-item--button mt-50">
                  <a href="blog-details.html">
                    Read more <i className="far fa-arrow-right" />
            ...
            <div className="sidebar_widget">
              ...
              <ul className="recent_post_block list-unstyled">
                <li className="recent_post_item">
                  ...
                  <span>
                    <img src="assets/front/img/icon/profile-circle.svg" alt="" />
                    By Michael david
                  </span>
                </li>
                <li className="recent_post_item">
      ...
      <div className="cta-wrap">
        <div className="cta-inner ul_li_between">
          ...
          <div
            ...
            data-wow-duration="600ms"
          >
            <img className="updown" src="assets/front/img/cta/clip-bord.png" alt="" />
          </div>
        </div>
      </div>
    </div>
